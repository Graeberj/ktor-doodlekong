...
import com.plcoding.util.Constants.TYPE_DISCONNECT_REQUEST
import com.plcoding.util.Constants.TYPE_DRAW_ACTION
...
import com.plcoding.util.Constants.TYPE_PING
    ...
    route("/ws/draw"){
        standardWebSocket { socket, clientId, message, payload ->
            when(payload){
                ...
                is ChosenWord -> {
                    val room = server.rooms[payload.roomName] ?: return@standardWebSocket
                    room.setWordAndSetToRunning(payload.chosenWord)
                }
                is ChatMessage -> {
                    val room = server.rooms[payload.roomName] ?: return@standardWebSocket
